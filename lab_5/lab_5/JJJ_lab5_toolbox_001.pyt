...
class Tool(object):
    def __init__(self):
        ...
        self.label = "JJ Building prox"
        self.description = "building buffer"
        self.canRunInBackground = False
        self.category = 'Building Tools'

    def getParameterInfo(self):
        """Define parameter definitions test test """
        ...
        param2 = arcpy.Parameter(displayName = 'garage CSV path', name = 'garageCSVfileaddress', datatype = 'DEFile', parameterType = 'Required', direction = 'Input')
    ...
    def execute(self, parameters, messages):
        ...
        if shouldProceed: 
            ...
            # buffer 
            garage_buff_name = database + '/building_buffered_%s' % (bufferSize_input)
            ...
            arcpy.AddMessage('Great Work, Jonesy!!! WHOOP!!!')
        else: 
            arcpy.AddError('Please try again... ')
